      ...
      <div className="mx-auto w-full max-w-6xl px-5 py-16 sm:px-8">
        <div className="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-muted-2">
              RezonanÈ'Äƒ magneticÄƒ cerebralÄƒ Ã®n {site.affideaFootprint}. PreÈ'
              transparent, aparate de cÃ¢mp Ã®nalt È'i rezultate rapide.
            </p>
            <p className="mt-4 text-xs text-muted-2">{site.operatorNote}</p>
          </div>

          <nav aria-label="Navigare footer">
            <p className="eyebrow text-muted-2">PaginÄƒ</p>
          ...
          <div>
            <p className="eyebrow text-muted-2">ProgramÄƒri</p>
        ...
        <div className="mt-14 border-t border-line-dark pt-8">
          <p className="max-w-3xl text-xs leading-relaxed text-muted-2">
            ...
            InformaÈ'iile de pe aceastÄƒ paginÄƒ au scop educativ È'i nu Ã®nlocuiesc
            consultul unui medic. Recomandarea de investigaÈ'ie È'i interpretarea
            rezultatului aparÈ'in medicului specialist.
          </p>
          <div className="mt-6 text-xs text-muted-2">
            <p>Â© {"2026"} Affidea. Toate drepturile rezervate.</p>
          </div>
        </div>
      </div>
    </footer>
