...
export function ClinicalSection() {
  return (
    <Section
      ...
      tone="paper"
      eyebrow="IndicaÈ'ii"
      title="CÃ¢nd este recomandat un RMN cerebral?"
      intro="Medicul specialist recomandÄƒ un RMN cerebral pentru a investiga simptome neurologice sau pentru a diagnostica È'i monitoriza numeroase afecÈ'iuni ale creierului."
    >
      <div className="mb-12">
      ...
      <div>
        <h3 className="font-display text-lg font-semibold text-ink">
          Ce evidenÈ'iazÄƒ RMN-ul cranio-cerebral
        </h3>
        <div className="mt-5">
      ...
      <div className="mt-12 select-none overflow-hidden rounded-2xl bg-primary-dark p-8 text-paper-100 sm:p-10">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-2xl">
            <Eyebrow onDark>Focus Â· Accident vascular cerebral</Eyebrow>
