...
const steps = [
  "Mergi la medicul de familie pentru o trimitere cÄƒtre medicul specialist.",
  "Medicul specialist evalueazÄƒ simptomele È'i emite biletul de trimitere pentru RMN.",
  "Ne suni sau completezi formularul, iar noi Ã®È'i confirmÄƒm programarea.",
];
...
export function CnasSection() {
  return (
    <Section
      ...
      intro="Cu un bilet de trimitere valabil de la medicul specialist, RMN-ul cerebral este decontat integral de Casa de AsigurÄƒri de SÄƒnÄƒtate: 0 lei pentru pacientul asigurat."
    >
      <div className="grid gap-10 lg:grid-cols-2">
        <div>
          <h3 className="font-display text-lg font-semibold text-paper-100">
            Programul Monitor: RMN gratuit È'i prioritar
          </h3>
          <p className="mt-3 leading-relaxed text-muted-2">
            Medicul specialist noteazÄƒ """Monitor 1""¦7""" pe biletul de trimitere.
            PacienÈ'ii din aceste categorii beneficiazÄƒ de RMN gratuit, nelimitat
            È'i prioritar, chiar È'i dupÄƒ epuizarea plafonului lunar.
          </p>
        ...
        <div>
          <h3 className="font-display text-lg font-semibold text-paper-100">
            Cum obÈ'ii biletul de trimitere
          </h3>
          ...
          <Cta href="#programare" onDark className="mt-6">
            ProgrameazÄƒ cu bilet de trimitere
          </Cta>
        </div>
      </div>
    </Section>
